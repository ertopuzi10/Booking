...
namespace Booking.Application.Features.Users.Register
{
    public class RegisterUserCommandHandler : IRequestHandler<RegisterUserCommand, RegisterUserResponse>
    {
        ...
        public RegisterUserCommandHandler(IApplicationDbContext context, IAuthManager authManager, IEmailService emailService)
        {
            _context = context;
        ...
        public async Task<RegisterUserResponse> Handle(RegisterUserCommand request, CancellationToken cancellationToken)
        {
            ...
            // Send welcome email (fire-and-forget; errors are swallowed in the service)
            await _emailService.SendWelcomeAsync(user.Email, user.FirstName);
