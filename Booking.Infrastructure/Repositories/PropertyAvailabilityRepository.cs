namespace Booking.Infrastructure.Repositories
{
    ...
    public class PropertyAvailabilityRepository : IPropertyAvailabilityRepository
    {
        ...
        public Task<List<PropertyAvailability>> GetByPropertyAndMonthAsync(Guid propertyId, int year, int month, CancellationToken cancellationToken)
        {
        ...
        public Task<List<PropertyAvailability>> GetBlockedDatesAsync(Guid propertyId, IEnumerable<DateTime> dates, CancellationToken cancellationToken)
        {
