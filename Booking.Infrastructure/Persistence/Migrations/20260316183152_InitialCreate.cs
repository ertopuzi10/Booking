        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityCardNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    CreditCard = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinStayNights = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    MaxStayNights = table.Column<int>(type: "int", nullable: true),
                    CleaningFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    ExtraGuestFeePerNight = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    BaseGuestsIncluded = table.Column<int>(type: "int", nullable: false, defaultValue: 2),
                    ServiceFeePercent = table.Column<decimal>(type: "decimal(5,4)", nullable: false, defaultValue: 0.10m),
                    TaxPercent = table.Column<decimal>(type: "decimal(5,4)", nullable: false, defaultValue: 0.085m),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
